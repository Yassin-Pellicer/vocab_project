...
export default function DictionaryComponent({
  ...
  return (
    <div>
      <div className="bg-background flex justify-between items-center h-16 border-b pr-4 pl-1 shadow-sm">
        ...
        <div className="flex flex-row items-center gap-2">
          ...
          <button
            ...
            className={toolbarBtn(graphMode)}>
            <TreesIcon size={18} />
          </button>
          <button
            title="Flip translations"
            onClick={() => setIsFlipped(!isFlipped)}
            className={toolbarBtn(isFlipped)}>
