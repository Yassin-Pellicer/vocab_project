      ...
      <DialogContent className="w-full p-0">
        <div className="p-6 pb-2 overflow-auto max-h-[75vh]">
          <DialogHeader>
            ...
            <DialogDescription>
              If the language of your dictionary is gendered and accounts
              for singular and plural forms, you can add the appropriate
              options here. Edit the types of words, tenses and the
              definite articles used in your dictionary.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="grid gap-4">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  onChange={(e) =>
                    hook.setInputTypeWord(e.target.value)
                  }
                />
                <Button
                  type="button"
              ...
              <div className="flex gap-2">
                <Input placeholder="Enter value" value={hook.genderNumberInput} onChange={(e) => hook.setGenderNumberInput(e.target.value)} />

                <Select value={hook.selectedForm} onValueChange={hook.setSelectedForm}>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div
                  className="flex flex-row gap-2"
                >
                  <Select value={hook.inputNumber} onValueChange={hook.setInputNumber}>
                    <SelectTrigger className="w-full">
                      <SelectValue placeholder="Select form" />
                    </SelectTrigger>
                    <SelectContent>
                      {metadata?.numbers?.map(
                        (form: string) => (
                          <SelectItem
                            key={form}
                            value={form}
              ...
              <DialogDescription className="text-xs">
                ...
                definite article before nouns based
                on their gender and number.
              </DialogDescription>
              ...
              <DialogDescription className="text-xs">
                With tenses enabled you will be able
                to configure verbal tenses and
                conjugations for your dictionary.
                You will need to configure which
                type of word has its tenses enabled.
              </DialogDescription>
