    ...
    <div className="mb-8 mt-2 px-1.5">
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between rounded-md group gap-4">
          ...
          <button className="h-9 hover:text-muted-foreground px-4 rounded-md border border-destructive bg-background text-sm text-destructive hover:bg-destructive transition-colors shrink-0">
            Cancel
          </button>
        </div>
      </div>
