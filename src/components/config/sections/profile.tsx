          ...
          <div className="flex py-2 items-center flex-1 gap-4">
            <div className="flex-1 gap-4">
              ...
              <div className="text-xs text-muted-foreground lg:w-3/4 w-full">
                Upload a custom avatar image to personalize your profile.
                Supported formats are JPEG, PNG, and WebP with a maximum size of
                2 MB. The image will be cropped to a circle.
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between rounded-md  group gap-4">
          <div className="flex py-2 items-center flex-1 gap-4">
            <div className="flex-1 gap-4">
              ...
              <div className="text-xs text-muted-foreground lg:w-3/4 w-full">
                Set the name displayed across the application. This name is
                visible on your profile and in any shared content or activity.
              </div>
            </div>
          </div>
          <input
        ...
        <div className="flex items-center justify-between rounded-md  group gap-4">
          <div className="flex py-2 items-center flex-1 gap-4">
            <div className="flex-1 gap-4">
              ...
              <div className="text-xs text-muted-foreground lg:w-3/4 w-full">
                Your email address is used for account recovery, notifications,
                and login. Changing your email will require verification through
                a confirmation link.
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between rounded-md  group gap-4">
          <div className="flex py-2 items-center flex-1 gap-4">
            <div className="flex-1 gap-4">
              ...
              <div className="text-xs text-muted-foreground lg:w-3/4 w-full">
                Switch to offline mode to use the application without an
                internet connection. Note that subscription features require
                being logged in and connected to the internet — they will be
        ...
        <div className="flex items-center justify-between rounded-md  group gap-4">
          <div className="flex py-2 items-center flex-1 gap-4">
            <div className="flex-1 gap-4">
              ...
              <div className="text-xs text-muted-foreground lg:w-3/4 w-full">
                This action cannot be undone. All your dictionaries, progress,
                and active subscriptions will be immediately cancelled and
                removed from our servers. Your dictionaries and all local data
                will still be available though, and you will go offline after
                deletion.
              </div>
            </div>
          </div>
