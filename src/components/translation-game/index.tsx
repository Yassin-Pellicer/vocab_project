            ...
            <CardHeader className="gap-4 p-0! pt-4!">
              <div className="flex flex-wrap items-start justify-between gap-4 shrink-0 ">
                <div className="space-y-2">
                  <CardTitle className="flex flex-row gap-2 text-3xl tracking-tight">
                    <BookCheck className="size-8" />
                    <span>Train with {dictionaryTitle}</span>
                  </CardTitle>
            ...
            <div className="mx-auto w-full">
              <Card className="border-border/60">
                ...
                <CardContent className="grid gap-4 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
                        ...
                        {availableTypes.map((type) => {
                          ...
                          return (
                            <label
                              key={type}
                              className={cn(
                                "flex items-center gap-3 rounded-2xl border shadow- px-4 py-3 transition-colors",
                                checked
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-border/60 bg-accent/10 px-4 py-4 lg:col-span-2">
                    <div>
